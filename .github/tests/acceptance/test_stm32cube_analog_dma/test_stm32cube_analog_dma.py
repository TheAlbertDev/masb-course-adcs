...
def test_potadc_tracks_sinus_signal(setup_hardware):
    ...
    The DMA updates potADC at ~42 kHz; the serial stream is the bottleneck
    (~880 samples/s at 115200 baud), providing many samples per sinus cycle.
    """
    ...
    save_comparison_chart(
        ...
        "stm32cube_analog_dma_potadc_comparison.png",
        label="potADC"
    )
